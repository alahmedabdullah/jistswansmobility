...
public final class Constants
{
  ...
  public static double betarnd(double a, double b) {
  	  BetaDist betaDist  = new BetaDist(a, b);
  	  betaUniform = new BetaGen(stream, betaDist);
  	  return betaUniform.nextDouble();
  }
  ...
  public static final int MOBILITY_UNIFORM   = 7;
  /** node mobility choice constant. */
